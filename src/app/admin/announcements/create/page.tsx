...
export default function CreateAnnouncementPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (userError || !user) {
        throw new Error('Please sign in to create announcements');
      }

      // Get user profile to get the author_id
      ...
      const { error: insertError } = await supabase
        ...
        .insert({
          ...
          is_pinned: isPinned,
          team_id: teamId || null, // null for general announcements
          author_id: profile.id // Use author_id from your schema
        });
      ...
      setTimeout(() => {
        ...
        router.refresh(); // Refresh the page to show new announcement
      }, 1500);
    } catch (err: any) {
